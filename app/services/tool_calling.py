    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "Shopify store (read/fix/update products, pages, SEO) → provisioning_agent, "
                "video generation → video_agent, "
                "email/SMS/Slack → communication_agent, "
                "bulk outreach/cold email → outreach_agent, "
                "find emails/lead gen/industry scan → scout_agent, "
                "deep research → research_agent, "
                "website audit/competitor analysis → apex_architect_agent, "
                "website analysis/performance → analyst_agent, "
                ...
                "CRITICAL: For Shopify store tasks (read products, fix SEO, update store), "
                "ALWAYS delegate to provisioning_agent — it has real Shopify Admin API access. "
