...
async def process_chat(
    ...
    DELEGATE_KEYWORDS = {
        ...
        "provisioning_agent": ["llc formation", "form an llc", "create an llc", "file llc",
                               ...
                               "fix my shopify", "fix my store", "update my shopify", "update my store",
                               "shopify products", "shopify pages", "shopify seo",
                               "read my shopify", "read my store", "shopify fix",
                               "fix the store", "update the store", "fix products", "fix seo"],
